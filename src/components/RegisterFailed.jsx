    ...
    return (
        <main className="main">
            ...
            <div className="error-content text-center" style={{ backgroundImage: ' url(assets/images/backgrounds/error-bg.jpg)' }}>
                <div className="container">
                    <h1 className="error-title">Registered Failed! </h1>
                    <p>Email bạn vừa dùng để tạo tài khoản đã được đăng kí bởi 1 tài khoản khác!</p>
                    <p>Vui lòng sử dụng 1 email khác rồi thực hiện đăng kí lại!</p>
